...
public class CourseRecyclerAdapter extends BaseAdapterRecycler<CourseDetailBean> {

    private Context mContext;
//    private List<IndexMallRecyclerBean> listMall;
    private RecyclerView.LayoutManager layoutManager;

    public CourseRecyclerAdapter(Context context, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        CourseDetailBean bean = (CourseDetailBean) getItem(position);
        final IndexViewHolder viewHolder = (IndexViewHolder) holder;
        viewHolder.tv_mall_title.setText(bean.getCourse_name());
